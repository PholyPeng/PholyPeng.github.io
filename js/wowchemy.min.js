...
See: https://github.com/francoischalifour/medium-zoom`)
        ...
        function A(e) { 
            ...
            if (t === null) return; 
            switch (e) { 
                case 0: t.classList.add("dropdown-item-active"), 
                ...
                break;
                case 1: t.classList.remove("dropdown-item-active"), 
                n.classList.add("dropdown-item-active"), 
                s.classList.remove("dropdown-item-active"),
                ico.classList.remove("fa-sun"),
                ico.classList.add("fa-moon");
                break; 
                default: t.classList.remove("dropdown-item-active"), 
                n.classList.remove("dropdown-item-active"), 
